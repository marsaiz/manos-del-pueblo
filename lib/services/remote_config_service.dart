...
class RemoteConfigService {
  ...
  Future<void> initialize() async {
    ...
    await _remoteConfig.setDefaults({
      ...
      'manos_min_version_android': '1.2.2',
      'manos_min_version_ios': '1.2.2',
      'manos_min_version_web': '1.2.2',
      'manos_latest_version_android': '1.2.2',
      'manos_latest_version_ios': '1.2.2',
      'manos_latest_version_web': '1.2.2',
