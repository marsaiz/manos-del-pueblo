#!/usr/bin/env python3
"""
Script para crear Feature Graphic (1024x500px) para Google Play Console
...
def crear_feature_graphic():
    ...
    if os.path.exists(logo_path):
        ...
        if logo.mode == 'RGBA':
            ...
            bg.paste(logo, mask=logo.split()[3])  # Usar canal alpha como máscara
            logo = bg
    ...
    try:
        ...
        # Texto simple sin fuentes especiales
