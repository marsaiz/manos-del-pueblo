#!/usr/bin/env python3
"""
Script para crear Feature Graphic de ALTA CALIDAD (1024x500px)
Sin compresión para mayor tamaño de archivo
...
def crear_feature_graphic_hq():
    ...
    # Crear imagen base con modo RGB de alta calidad
    ...
    if os.path.exists(logo_path):
        ...
        # Redimensionar logo (mantener proporción, altura máxima 350px)
        logo_height = 350
        ...
        # Si el logo tiene transparencia, crear una versión sin alpha
        if logo.mode == 'RGBA':
            # Crear fondo
        ...
        # Posición del texto (a la derecha del logo)
        text_x = logo_x + logo_width + 60
    else:
        print("⚠️  Logo no encontrado, creando solo con texto")
        text_x = 100
    ...
    # Guardar SIN OPTIMIZACIÓN para mayor tamaño de archivo
    output_path = "assets/feature_graphic_hq.png"
    ...
    print(f"✓ Feature Graphic HQ creado: {output_path}")
